...
RSpec.describe Recipe do
  describe '.create' do
    before(:each) do
      @ingredient = Ingredient.create!(name: "broccoli")
      @recipeCollection
      @recipe = Recipe.create!(title: "Crispy Garlic Broccoli", description: "tasty and healthy", ingredients: "6 cups of broccoli florets", rating: 4, directions: "Preheat oven to 425°. Mix broccoli florets, 1 tablespoon extra-virgin olive oil, and 1 tablespoon chopped garlic; roast in middle of oven until golden and crispy (10-15 minutes). Transfer to a serving bowl; toss with 1 teaspoon sesame oil.")
    end
